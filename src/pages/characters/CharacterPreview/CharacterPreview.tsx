...
import { CloseButton, MoneyIconWithPrice, PersonImage } from "../../../components";
import { setCharacter, Person, setInitialCredits } from "../../../redux/slices";
...
export const CharacterPreview = ({ character, close }: Props) => {
   ...
   const handleClick = () => {
      ...
      dispatch(setInitialCredits(character.spendings));
   };
                  ...
                  <>
                        ...
                        <Info>
                           ...
                           <div>
                              ...
                              <InfoFooterText>
                                 ...
                                 <InfoFooterWarning>начальной суммы</InfoFooterWarning> вы
                                 выплачиваете в месяц по этому долгу
                              </InfoFooterText>
                           </div>
                        </Info>
                     </PreviewAbout>
                     ...
                     <Total>
                        <TotalGain>
                           ...
                           <Column
                              title="Долги"
                              value={-character.spendingsMonthPayment}
                           />
                           <Column
                              title="Итого"
