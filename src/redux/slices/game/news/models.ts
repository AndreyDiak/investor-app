   ...
   events: [
      {
         ...
         titles: [
            ...
            {
               title: "Вам досталось наследство семьи! Потратьте его с умом",
               amount: 2500,
            },
            ...
            {
               title: "У вашего босса хорошее настроение, вы получили премию",
               amount: 220,
            },
   ...
   events: [
      {
         ...
         titles: [
            ...
            {
               title: "Квартальный отчет показал хорошие результаты, доход компании показал рост!",
            },
            {
               title: "Компания показала хороший рост в этом квартале, рост акций не заставит себя ждать!",
            },
            {
               title: "Компания заняла лидирующие позиции в своём сегменте рынка, думаю вам стоит присмотреться к ней!",
            },
            {
               title: "Брокеры предсказывают рост доходов в следующем квартале, обратите на нее внимание!",
            },
            {
               title: "Компанию покупает лидер рынка, новое начальство знает, что надо делать!",
            },
         ],
      },
      {
         ...
         titles: [
            ...
            {
               title: "Компании S&P 500 показывают хорошие квартальный результаты, инвесторы могут быть спокойны!",
            },
            {
